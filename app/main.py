...
def email_lookup_hash(email_norm: str) -> bytes:
    # MVP: hash deterministe (pas de pepper, pas de chiffrement fort pour l'instant)
...
def create_user(payload: UserCreate):
    ...
    email_lookup = email_lookup_hash(email_norm)      # bytea
    email_ciphertext = email_norm.encode("utf-8")     # bytea (TEMPORAIRE: email en clair)
